...
public class P1T1_Get : MonoBehaviour {
	...
	private IEnumerator WaitForRequest()
	{
		...
		if (get.error == null)
		{
			...
			string json = @getreq;
			List<MyP1T1_Get> data = JsonConvert.DeserializeObject<List<MyP1T1_Get>>(json);
			int l = data.Count;
			Debug.Log("Latest Data: " + data[l - 1].content);
			text.text = "Data: " + data[l - 1].content.Split(',')[0];
		}
		else
		{
