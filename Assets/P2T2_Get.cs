...
public class P2T2_Get : MonoBehaviour {
	...
	private IEnumerator WaitForRequest()
	{
		...
		if (get.error == null)
		{
			...
			string json = @getreq;
			List<MyP2T2_Get> data = JsonConvert.DeserializeObject<List<MyP2T2_Get>>(json);
			int l = data.Count;
			Debug.Log("Latest Data: " + data[l - 1].content);
			text.text = "Data: " + data[l - 1].content.Split(',')[3];
		}
		else
		{
